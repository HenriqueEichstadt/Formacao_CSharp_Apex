namespace Capitulo11.Polimorfismo
{
    ...
    {
        /*
         Nesse exemplo, temos uma classe base 'Pessoa' e uma classe derivada 'Aluno' (herdando de pessoa). 
         A classe base(mãe) tem um método 'Falar', que é virtual, e a classe derivada sobrescreve esse método. 
